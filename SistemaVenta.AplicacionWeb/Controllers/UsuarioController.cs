    ...
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Crear([FromForm] IFormFile? foto, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                VMUsuario vmUsuarioCreado = _mapper.Map<VMUsuario>(usuarioCreado);

                gResponse.Estado = true;
                gResponse.Objeto = vmUsuarioCreado;
            }
            catch (Exception ex)
            {
            ...
            public async Task<IActionResult> Editar([FromForm] IFormFile? foto, [FromForm] string modelo)
            {
                ...
                try
                {
                    ...
                    Usuario usuarioEditado = await _usuarioServicio.Editar(
                        _mapper.Map<Usuario>(vmUsuario),
                        fotoStream,
                        nombreFoto
                    );

                    VMUsuario vmUsuarioEditado = _mapper.Map<VMUsuario>(usuarioEditado);
        ...
        public async Task<IActionResult> Eliminar(int IdUsuario)
        {
            GenericResponse<string>
                gResponse = new GenericResponse<string>();
