...
let tablaData;
let filaSeleccionada; // <-- IMPORTANTE: Declarada aquí arriba
...
// 3. BOTÓN NUEVA CATEGORÍA (Ahora sí funcionará con el ID que pusimos en el Index)
$("#btnNuevo").click(function () {
    mostrarModal();
});

// 4. BOTÓN GUARDAR (CREAR Y EDITAR)
...
// 5. BOTÓN EDITAR (DENTRO DE LA TABLA)
    ...
    swal({
        ...
        function (respuesta) {
            if (respuesta) {
                ...
                fetch(`/Categoria/Eliminar?IdCategoria=${data.idCategoria}`, { method: "DELETE" })
                    .then(response => {
